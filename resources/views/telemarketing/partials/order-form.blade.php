...
<div id="new-order-section" class="hidden mt-4" x-data="orderForm()" x-init="init()">
    <div class="bg-white overflow-hidden shadow rounded-lg border-2 border-green-300">
        <div class="px-6 py-5">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4 p-3 bg-gray-50 rounded-lg">
                <div>
                    ...
                    <template x-for="(item, index) in items" :key="index">
                        <div class="flex items-start gap-2 p-3 bg-gray-50 rounded-lg border">
                            ...
                            <div class="w-24 text-right">
                                ...
                                <p class="text-sm font-semibold text-gray-900 pt-1.5" x-text="'₱' + (item.quantity * item.unit_price).toFixed(2)"></p>
                            </div>
            ...
            <div class="flex items-center justify-between pt-3 border-t">
                ...
                <button type="button" @click="submitOrder()"
                        ...
                        :class="submitting || !isValid ? 'opacity-50 cursor-not-allowed' : 'hover:bg-green-700'"
    ...
    <div class="mt-4 bg-white overflow-hidden shadow rounded-lg">
        <div class="px-6 py-4">
            ...
            <div class="space-y-2">
                ...
                <div class="flex items-center justify-between p-2.5 bg-gray-50 rounded-lg text-sm border border-gray-100">
